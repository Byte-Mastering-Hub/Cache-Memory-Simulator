...
* ✅ Customizable **cache size (number of lines)**
* ✅ Displays:
...
* **JavaScript (Vanilla JS)** – Cache simulation logic
...
├── script.js       # Cache simulation logic
...
⭐ If this simulator helped you understand cache memory concepts, feel free to star the repository and share it!
